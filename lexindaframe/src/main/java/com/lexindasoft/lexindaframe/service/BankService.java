...
public interface BankService {
	...
	public List<ReportInfo> getReportInfoListByOpenIds(Map<String,Object> paramMap);
	
	public List<ReportInfo> getReportInfoListByOpenIdP(Map<String,Object> paramMap);
