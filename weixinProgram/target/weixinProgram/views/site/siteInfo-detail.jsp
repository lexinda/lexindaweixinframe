				...
				<div id="div_setting_1" class="contentList pad-10">
					...
					<input type="hidden" id="uploadImg" name="uploadImg" value="${siteInfo.siteInfoImg}"/>
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="tName" name="tName" value="${siteInfo.siteInfoName}" maxlength="50" />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label"><span class="required"></span>内容简介:</label>
							<div class="controls">
								<input type="text" id="tSax" name="tSax" value="${siteInfo.siteInfoSax}" maxlength="100" />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label"><span class="required">*</span>上传图片:</label>
							<div class="controls">
								<img src="${siteInfo.siteInfoImg }" alt="" />
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<textarea name="tContent" id="tContent" class="textItem" style="display:none;width:900px;height:246px;">${siteInfo.siteInfoContent}</textarea>
							</div>
						</div>
					</form>
				</div>
