...
<ul>
	<c:if test="${roleMap.user_manager == 1}">
		<li class="sub_menu"><a href="/cmsRstManage/user/manage?&page=1&" hidefocus="true" style="outline: none;">用户管理</a></li>
		<li class="sub_menu"><a href="/cmsRstManage/sale/queryHandlePeople?&page=1&" hidefocus="true" style="outline: none;">售后处理人员管理</a></li>
	</c:if>
