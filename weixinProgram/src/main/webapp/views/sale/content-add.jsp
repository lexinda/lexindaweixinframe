				...
				<div id="div_setting_1" class="contentList pad-10">
					<form id="addAdminUser" class="form-horizontal" action="/cmsRstManage/sale/reportContent" method="post">
						...
						<div class="control-group">
							...
							<div class="controls">
								<textarea name="content" id="content" class="textItem" style="width:300px;height:246px;"></textarea>
							</div>
						</div><span id="contentText" style="color:red;"></span>
					</form>
				</div>
