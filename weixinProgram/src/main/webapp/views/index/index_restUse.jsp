...
<body id="top">
  ...
  <div class="telbgx">
  	<div class="m30 content clearfix">
				<div class="w790 f_L" style="text-align:center;">
				<h1><span>注册</span>流程</h1>
				<img src="../images/templates/bmf_app1.jpg"/>
				<h1><span>审核</span>流程</h1>
				<img src="../images/templates/bmf_app2.jpg"/>
				<h1><span>刷卡</span>收款</h1>
				<img src="../images/templates/bmf_app3.jpg"/>
        </div>
        <div class="w160 f_R">
