...
<body id="top">
		...
		<div class="bd">
			<ul>
				<li style="background: #e6e6e6;">
					<img class="bg"
							src="http://www.1003team.com/v201397/images/blank.png" />
					<div class="pic">
						<a href="/#"><img
							src="../images/chazhang.png" /></a>
					</div>
				</li>
			</ul>
		</div>
	...
	<div class="bgcw">
      <div class="m30 content">
        <div class="webCate">
          <div class="hd"><em class="tit">查账登陆</em></div>
          <div class="bd">
            <ul class="clearfix">
		<li>
                <div class="pic hover"><a href="http://mas.chinapnr.com/psu/" target="_blank" ><img src='../images/templates/one.png' border='0' width='500' height='180' alt='汇付天下'/></a></div>
                <div class="btns" style="margin-top:10px;">
                    <a class="f_R btn hover" href="http://mas.chinapnr.com/psu/" target="_blank" >点击登录</a>
                    <strong class="red">汇付天下</strong>
                </div>
              </li>
<li>
                <div class="pic hover"><a href="http://merchant.allinpay.com/ms/merchant/login/logoff.do" target="_blank" ><img src='../images/templates/two.png' border='0' width='320' height='180' alt='通联支付'/></a></div>
                <div class="btns" style="margin-top:10px;">
                    <a class="f_R btn hover" href="http://merchant.allinpay.com/ms/merchant/login/logoff.do" target="_blank" >点击登录</a>
                    <strong class="red">通联支付</strong>
                </div>
              </li>
<li>
                <div class="pic hover"><a href="http://s.lakala.com/" target="_blank" ><img src='../images/templates/three.png' border='0' width='320' height='180' alt='拉卡拉'/></a></div>
                <div class="btns" style="margin-top:10px;">
                    <a class="f_R btn hover" href="http://s.lakala.com" target="_blank" >点击登录</a>
                    <strong class="red">拉卡拉</strong>
                </div>
              </li>
			 </li>
<li>
                <div class="pic hover"><a target="_blank"  href="https://pos.shfft.com/fftSupdataCardMerConsole/login.jsp;jsessionid=MMtPJxnZJSpvMh6znF1NL2wHGrFyjs38p4RFVL4fpjSvzNJR2bl9!-1570186645"><img src='../images/templates/four.png' border='0' width='320' height='180' alt='付费通'/></a></div>
                <div class="btns" style="margin-top:10px;">
                    <a class="f_R btn hover" target="_blank" href="https://pos.shfft.com/fftSupdataCardMerConsole/login.jsp;jsessionid=MMtPJxnZJSpvMh6znF1NL2wHGrFyjs38p4RFVL4fpjSvzNJR2bl9!-1570186645">点击登录</a>
                    <strong class="red">付费通</strong>
                </div>
              </li>
