...
<link type="text/css" rel="stylesheet"
	...
	<link type="text/css" rel="stylesheet"
	href="../css/templates/listsstyle.css" />
...
<script type="text/javascript" src="../js/templates/lists.js"></script>
</head>
<body id="top">
	<div id="backTop">
  ...
  <div class="pageNav" id="fixNav">
  	<ul class="clearfix center">
      	      ...
      	      <li><a href='http://www.rstpay.com/hr/' >工作机会</a></li>
      	
      	      <li><a href='http://www.rstpay.com/contact/' >联系方式</a></li>
...
<div class="bgcw">
	<div class="content m30 clearfix">
		<div class="w790 f_L">
<div class="pages">
	<p style="text-indent:2em;"><strong><span style="color:#555555;font-family:verdana, arial, helvetica, sans-serif;line-height:22px;">上海融商网络科技有限公司</span></strong><span style="color:#555555;font-family:verdana, arial, helvetica, sans-serif;line-height:22px;">（简称“上海融商”）成立于2012年02月，是一家综合性支付服务代理企业，总部设立于上海。得益于成熟的收单市场经验、在全国金融中心的地理位置、信息畅通并与全国的主要第三方机构有着成熟的渠道合作关系，上海融商于2012年6月成立黑龙江分公司，吉林分公司，河南分公司和辽宁分公司。</span></p><p style="text-indent:2em;"><span style="color:#555555;font-family:verdana, arial, helvetica, sans-serif;line-height:22px;">目前，员工总数近百人，月刷卡流量超过10个亿，终端数超过20000台未来公司发展将以支付业为基础，逐步扩展到其他金融服务领域，并最终形成一套完善的综合服务及产品体系，力争以全方位竞争优势，成长为业界领先的行业支付解决方案及综合支付服务代理商。并于同年6月开始拓展哈尔滨收单市场，成立黑龙江分公司目前已有稳定商户1500余个，每个月的商户数量成倍增长、交易量以几何级数上升。</span></p><p style="text-indent:2em;"><span style="color:#555555;font-family:verdana, arial, helvetica, sans-serif;line-height:22px;">分公司未来目标：半年内月交易量要突破亿元，市场占有率每年递增5%（10000个商户），三年内成为当地同行业中的主流支付服务公司。</span></p>
</div>
...
<br />
		...
		<div class="w160 f_R">
      	...
      	<li><a href='http://www.rstpay.com/contact/' >联系方式</a></li>
			...
			<div class="ustel">
				<div class="tel red">
					<div>咨询热线：</div><p>18601620662</p></div>
				<div>
			   </div>
			</div>
		</div>
