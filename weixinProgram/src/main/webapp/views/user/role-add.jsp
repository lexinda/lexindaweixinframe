...
<body>
	<ul class="nav nav-tabs">
		<li>
		<a href="/user/adminrole/manage"> <em>角色管理</em>
		</a>
		</li>
		<li class="active">
		<a href="javascript:void(0);" class="on"> <em>添加角色</em>
		</a>
		</li>
	</ul>
		...
		<div class="pad-10">
			...
			<div class="col-tab">
				...
				<div id="div_setting_1" class="contentList pad-10">
					<form id="addRole" class="form-horizontal" action="/user/role/add" method="post">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="roleDesc" name="roleDesc" value="" maxlength="150" />
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<label class="radio inline">
        							<input type="radio" name="isEnable" value="0" checked/>是
     					 		</label>
     					 		<label class="radio inline">
        							<input type="radio" name="isEnable" value="1"/>否
     					 		</label>
							</div>
						</div>
					</form>
